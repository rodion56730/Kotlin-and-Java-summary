...
enum - класс с конечным числом связанных констант, каждая из которых  определена изначально. 
Пример:
```java
enum DayOfWeek { 
	MONDAY, 
...
[[Собес по проге/Java/Generics|Дженерики]] в enum использовать нельзя.
